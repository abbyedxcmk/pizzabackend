            ...
            <div className="card-body p-4 pb-2 border-dark">
              <div className='d-flex text-start justify-content-between align-items-start'>
                <div className=''>
                  ...
                  <p className="card-title fs-6 fw-bold pizza-size-checkout color-2">SIZE: <span className='color-1'>SMALL</span></p>
                </div>
              ...
              <div className='d-flex justify-content-between text-start'>
                <p className='fs-5 mt-3 color-1'>Tomato Sauce, Fior di Latte Mozzarella, Fresh Basil, Olive Oil</p>
                <h3 className='fs-1 fw-bold color-1'>£14</h3>
              </div>
            </div>
          </div>
        </div>
